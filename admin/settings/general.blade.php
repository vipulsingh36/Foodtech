                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    @if(empty($item->site_logo))
                                                        <img class="img-thumbnail" id="image" src="{{asset('public/site/default.png')}}" width="150px" >
                                                    @else
                                                        <img class="img-thumbnail" id="image" src="{{asset('public/site/'.$item->site_logo)}}" width="150px" >
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
