                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 text-right">
                                    @if($flash_deal->flash_image != '')
                                        <img id="image" src="{{asset('public/flash-deals/'.$flash_deal->flash_image)}}" alt=""  width="100px">
                                    @else
                                        <img id="image" src="{{asset('public/flash-deals/default.png')}}" alt=""  width="100px">
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
                                            ...
                                            <table class="table table-bordered mt-3">
                                                <tbody id="flash">
                                                    ...
                                                    <tr id="prd{{$item->product_id}}">
                                                        <td><img id="image" src="{{asset('public/products/'.$item->thumbnail_img)}}" alt=""  width="100px"></td>
                                                        <td>
