...
$('#add_product').validate({
    ...
    submitHandler: function (form) {
        ...
        // ✅ Properly append single image file
        var imageFile = $('input[name^=gallery]')[0]?.files[0];
        if (imageFile) {
...
$('#update_product').validate({
    ...
    submitHandler: function (form) {
        ...
        // ✅ Properly append update image file
        var imageFile = $('input[name^=gallery1]')[0]?.files[0];
        if (imageFile) {
            formdata.append('gallery', imageFile);
        }
