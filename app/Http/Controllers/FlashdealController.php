        ...
        if($request->ajax()){
            ...
            return Datatables::of($data)
                ...
                ->editColumn('image', function($row){
                    if($row->flash_image != ''){
                        $img = '<img src="'.asset("public/flash-deals/".$row->flash_image).'" width="80px">';
                    }else{
                        $img = '<img src="'.asset("public/flash-deals/").'" width="100px">';
                    }
                    return $img;
                })
            ...
            if(!empty($products)){
                foreach($products as $row){
                    $output .= '<tr id="prd'.$row->id.'">
                        <td>
                            <img src="'.asset("public/products/".$row->thumbnail_img).'" width="80px">
                        </td>
                        <td>
