...
<?php $__env->startComponent('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard','All Cities'=>'admin/cities']]); ?>
    <?php $__env->slot('title'); ?> Add City <?php $__env->endSlot(); ?>
    <?php $__env->slot('add_btn'); ?>  <?php $__env->endSlot(); ?>
    <?php $__env->slot('active'); ?> Add City <?php $__env->endSlot(); ?>
    ...
    <div class="container-fluid card-body">
        ...
        <form class="form-horizontal" id="add_city"  method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                   <input type="hidden" class="url" value="<?php echo e(url('admin/cities')); ?>" >
                    <!-- jquery validation -->
                    <div class="card">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/script/resources/views/admin/cities/create.blade.php ENDPATH**/ ?>