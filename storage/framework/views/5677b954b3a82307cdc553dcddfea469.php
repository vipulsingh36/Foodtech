...
<head>
  ...
  <title><?php echo $__env->yieldContent('title'); ?> | <?php echo e(site_settings()->site_name); ?></title>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/summernote-bs4.css')); ?>">
  ...
  <link rel="stylesheet" href="<?php echo e(asset('public/assets/css/Taginput.css')); ?>">
...
<div class="wrapper">
    ...
    <ul class="navbar-nav">
      <div class="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="<?php echo e(url('admin/profile-settings')); ?>">My Profile</a>
  ...
  <!-- /.navbar -->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/script/resources/views/admin/components/header.blade.php ENDPATH**/ ?>