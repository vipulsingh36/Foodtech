...
<div class="content-wrapper">
    ...
    <?php $__env->startComponent('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard']]); ?>
        <?php $__env->slot('title'); ?> Product Sale Report <?php $__env->endSlot(); ?>
        <?php $__env->slot('add_btn'); ?>  <?php $__env->endSlot(); ?>
        <?php $__env->slot('active'); ?> Product Sale Report <?php $__env->endSlot(); ?>
    ...
    ['S No.','Product Name','Sale']
        ...
        <?php $__env->slot('table_id'); ?> sale_list <?php $__env->endSlot(); ?>
    <?php echo $__env->renderComponent(); ?>
</div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/script/resources/views/admin/product-sale/index.blade.php ENDPATH**/ ?>