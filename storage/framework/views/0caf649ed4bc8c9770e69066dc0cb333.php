...
<div class="content-wrapper">
    ...
    <?php $__env->startComponent('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard']]); ?>
        <?php $__env->slot('title'); ?> All Tax <?php $__env->endSlot(); ?>
        <?php $__env->slot('add_btn'); ?> <a href="<?php echo e(url('admin/tax/create')); ?>" class="align-top btn btn-sm btn-primary">Add New</a> <?php $__env->endSlot(); ?>
        <?php $__env->slot('active'); ?> All Tax <?php $__env->endSlot(); ?>
    ...
    <?php $__env->startComponent('admin.components.data-table',['thead'=>
        ...
        <?php $__env->slot('table_id'); ?> tax_list <?php $__env->endSlot(); ?>
    <?php echo $__env->renderComponent(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/script/resources/views/admin/tax/index.blade.php ENDPATH**/ ?>