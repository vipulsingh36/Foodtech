...
<?php $__env->startComponent('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard','All Category'=>'admin/category']]); ?>
    <?php $__env->slot('title'); ?> Add Category <?php $__env->endSlot(); ?>
    <?php $__env->slot('add_btn'); ?>  <?php $__env->endSlot(); ?>
    <?php $__env->slot('active'); ?> Add Category <?php $__env->endSlot(); ?>
    ...
    <div class="container-fluid card-body">
        ...
        <form class="form-horizontal" id="add_category"  method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                   <input type="hidden" class="url" value="<?php echo e(url('admin/category')); ?>" >
                    <!-- jquery validation -->
                    <div class="card">
                                    ...
                                    <div class="col-md-10">
                                        <select name="cat_attributes[]" class="form-control select2" multiple="multiple">
                                            <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($list->id); ?>"><?php echo e($attr->title); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/script/resources/views/admin/category/create.blade.php ENDPATH**/ ?>