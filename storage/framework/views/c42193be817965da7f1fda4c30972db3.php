...
<?php $__env->startComponent('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard','All Products'=>'admin/products']]); ?>
    ...
    <?php $__env->slot('active'); ?> Add Product <?php $__env->endSlot(); ?>
    ...
    <div class="container-fluid card-body">
        ...
        <form class="form-horizontal" id="add_product"  method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <!-- left column -->
                <div class="col-md-8">
                   <input type="hidden" class="url" value="<?php echo e(url('admin/products')); ?>" >
                    <!-- jquery validation -->
                    <div class="card mb-3">
...
<script src="<?php echo e(asset('public/assets/js/Taginput.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/script/resources/views/admin/products/create.blade.php ENDPATH**/ ?>