...
<footer class="main-footer">
  <strong>Copyright <?php echo date('Y'); ?> <a href="https://www.ashhanfoodtech.com/">AshhanFoodTech</a>.</strong>
  All rights reserved
</footer>
...
<script src="<?php echo e(asset('public/assets/js/summernote-bs4.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('public/assets/js/main_ajax.js')); ?>"></script>
<script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/script/resources/views/admin/components/footer.blade.php ENDPATH**/ ?>